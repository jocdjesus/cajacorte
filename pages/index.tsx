...
import { Plus, Minus, Calculator, FileText, Trash2, Download } from "lucide-react"

// Importa las bibliotecas de generación de PDF
...
export default function CorteCajaApp() {
  ...
  const handleDownloadPDF = () => {
    ...
    html2canvas(input, options).then((canvas) => {
      ...
      pdf.save(`Corte de Caja - ${fecha}.pdf`)
    })
  }
  ...
  return (
    <div className="corte-caja-app">
      <div className="container">
        ...
        {/* Contenedor principal que se va a capturar para el PDF */}
        <div ref={contentRef}>
          {/* Header */}
                        ...
                        <div key={key} className={`count-item count-item-${color}`}>
                          <div className="count-item-header">
                            ...
                            <span className="count-item-value">
                              {(conteoEfectivo[key] * value).toLocaleString("es-MX", { minimumFractionDigits: 2 })}
                            </span>
                          </div>
                          <input
                            type="number"
                  ...
                  <div className="count-card">
                    ...
                    <div className="count-list">
                      {[
                        ...
                        { label: "$0.50", key: "monedas050" as keyof ConteoEfectivo, value: 0.5, color: "gray" },
                      ].map(({ label, key, value, color }) => (
                        <div key={key} className={`count-item count-item-${color}`}>
                          <div className="count-item-header">
                            <label className="count-item-label">{label}</label>
                ...
                <div className="count-section">
                  <div className="total-final-card">
                    <div className="total-final-header">
                      ...
                      <div className="total-final-amount">${totalEfectivoContado.toLocaleString("es-MX", { minimumFractionDigits: 2 })}</div>
                    </div>
                    <div className="total-final-summary">
                      <div className="total-final-summary-item">
                        <div className="total-final-summary-item-content">
                          ...
                          <span className="total-final-value">${efectivoEsperado.toLocaleString("es-MX", { minimumFractionDigits: 2 })}</span>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        <div className="total-final-summary-item-content">
                          ...
                          <span className="total-final-value-diff">${Math.abs(diferencia).toLocaleString("es-MX", { minimumFractionDigits: 2 })}</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        {/* Botón de descarga del PDF movido al final */}
        <div className="download-button-container">
          <button onClick={handleDownloadPDF} className="button-download">
